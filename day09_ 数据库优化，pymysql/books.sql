...
CREATE TABLE `图书` (
  ...
  `aid` int(11) DEFAULT NULL COMMENT '关联作家表',
  `pid` int(11) DEFAULT NULL COMMENT '关联出版社表',
  PRIMARY KEY (`id`),
  KEY `aid` (`aid`),
  KEY `pid` (`pid`),
...
CREATE TABLE `author_press` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `a_id` int(11) DEFAULT NULL COMMENT '关联作家表',
  `p_id` int(11) DEFAULT NULL COMMENT '关联出版社表',
  PRIMARY KEY (`id`),
  KEY `a_id` (`a_id`),
  KEY `p_id` (`p_id`),
...
INSERT INTO `book` VALUES (2,'骆驼祥子','老舍','机械工业出版社',43,'2019-10-01','你是祥子么？'),(3,'茶馆','老舍','中国文学出版社',55,'2019-10-01','老北京'),(4,'呐喊','鲁迅','人民教育出版社',50,'2019-10-01','最后的声音'),(5,'朝花夕拾','鲁迅','中国文学出版社',58,'2020-01-01','好时光'),(6,'围城','钱钟书','中国文学出版社',44,'2020-01-01','你心中的围城是什么'),(7,'林家铺子','茅盾','机械工业出版社',51,'2019-10-01',NULL),(8,'巨人传','忘了','人民教育出版社',47,'2019-10-01',NULL);
...
-- Dump completed on 2020-10-14 10:56:13
