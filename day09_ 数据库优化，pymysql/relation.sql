...
CREATE TABLE `like_talk` (
  ...
  KEY `uid` (`uid`),
  KEY `pid` (`pid`),
  CONSTRAINT `like_talk_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `user` (`id`),
  CONSTRAINT `like_talk_ibfk_2` FOREIGN KEY (`pid`) REFERENCES `pyq` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pyq` (
  ...
  `u_id` int(11) DEFAULT NULL COMMENT '关系字段',
  PRIMARY KEY (`id`),
  KEY `u_id` (`u_id`),
  CONSTRAINT `pyq_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-10-14 10:56:30
